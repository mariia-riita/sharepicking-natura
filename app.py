...
# =========================================================================
st.set_page_config(page_title="Share Picking M.O. - Natura", page_icon="💵", layout="wide")
...
st.title("💵 Agente de Sourcing: Share Picking de Mão de Obra")
...
if arquivos_carregados:
    if not chave_configurada:
        ...
        # TODO O PROCESSAMENTO PESADO FOI TRAVADO DENTRO DO BOTÃO ABAIXO!
